...
const hosannaTranslations = {
  en: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna by Carine Sanadina', 'tracks.hosanna.coverAlt': 'Carine Sanadina logo for Hosanna', 'tracks.hosanna.fallback': 'Hosanna artwork is temporarily unavailable.', 'tracks.hosanna.number': 'Track 08', 'tracks.hosanna.description': 'A faith-filled song of praise and adoration.', 'tracks.hosanna.about': 'Hosanna is a worship song inviting listeners into an atmosphere of praise, faith, and heartfelt adoration.', 'hosannaSynopsis': 'A faith-filled song of praise and adoration.', 'tracks.hosanna.credits': 'Artist: Carine Sanadina\nPresented by Omoluabi Productions', 'tracks.hosanna.playLabel': 'Play Hosanna', 'tracks.hosanna.lyricsFallback': 'Lyrics coming soon.' },
  fr: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna par Carine Sanadina', 'tracks.hosanna.coverAlt': 'Logo de Carine Sanadina pour Hosanna', 'tracks.hosanna.fallback': 'L’illustration de Hosanna est temporairement indisponible.', 'tracks.hosanna.number': 'Piste 08', 'tracks.hosanna.description': 'Un chant de louange et d’adoration rempli de foi.', 'tracks.hosanna.about': 'Hosanna est un chant d’adoration qui invite à la louange, à la foi et à une adoration sincère.', 'hosannaSynopsis': 'Un chant de louange et d’adoration rempli de foi.', 'tracks.hosanna.credits': 'Artiste : Carine Sanadina\nPrésenté par Omoluabi Productions', 'tracks.hosanna.playLabel': 'Lire Hosanna', 'tracks.hosanna.lyricsFallback': 'Paroles bientôt disponibles.' },
  es: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna de Carine Sanadina', 'tracks.hosanna.coverAlt': 'Logo de Carine Sanadina para Hosanna', 'tracks.hosanna.fallback': 'La imagen de Hosanna no está disponible temporalmente.', 'tracks.hosanna.number': 'Pista 08', 'tracks.hosanna.description': 'Una canción de alabanza y adoración llena de fe.', 'tracks.hosanna.about': 'Hosanna es una canción de adoración que invita a la alabanza, la fe y la devoción sincera.', 'hosannaSynopsis': 'Una canción de alabanza y adoración llena de fe.', 'tracks.hosanna.credits': 'Artista: Carine Sanadina\nPresentado por Omoluabi Productions', 'tracks.hosanna.playLabel': 'Reproducir Hosanna', 'tracks.hosanna.lyricsFallback': 'Letra disponible próximamente.' },
  ln: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna ya Carine Sanadina', 'tracks.hosanna.coverAlt': 'Logo ya Carine Sanadina mpo na Hosanna', 'tracks.hosanna.fallback': 'Elilingi ya Hosanna ezali te mpo na mwa ntango.', 'tracks.hosanna.number': 'Loyembo 08', 'tracks.hosanna.description': 'Loyembo ya masanzoli mpe losambo oyo etondi na kondima.', 'tracks.hosanna.about': 'Hosanna ezali loyembo ya losambo oyo ebengisaka bayoki na masanzoli, kondima mpe losambo ya motema.', 'hosannaSynopsis': 'Loyembo ya masanzoli mpe losambo oyo etondi na kondima.', 'tracks.hosanna.credits': 'Moyembi: Carine Sanadina\nElakisami na Omoluabi Productions', 'tracks.hosanna.playLabel': 'Beta Hosanna', 'tracks.hosanna.lyricsFallback': 'Maloba ya loyembo ekoya kala mingi te.' },
  sw: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna ya Carine Sanadina', 'tracks.hosanna.coverAlt': 'Nembo ya Carine Sanadina kwa Hosanna', 'tracks.hosanna.fallback': 'Mchoro wa Hosanna haupatikani kwa muda.', 'tracks.hosanna.number': 'Wimbo 08', 'tracks.hosanna.description': 'Wimbo wa sifa na ibada uliojaa imani.', 'tracks.hosanna.about': 'Hosanna ni wimbo wa ibada unaowaalika wasikilizaji katika sifa, imani na kuabudu kwa moyo.', 'hosannaSynopsis': 'Wimbo wa sifa na ibada uliojaa imani.', 'tracks.hosanna.credits': 'Msanii: Carine Sanadina\nImewasilishwa na Omoluabi Productions', 'tracks.hosanna.playLabel': 'Cheza Hosanna', 'tracks.hosanna.lyricsFallback': 'Maneno ya wimbo yanakuja hivi karibuni.' },
  yo: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna láti ọwọ́ Carine Sanadina', 'tracks.hosanna.coverAlt': 'Àmì Carine Sanadina fún Hosanna', 'tracks.hosanna.fallback': 'Àwòrán Hosanna kò sí fún ìgbà díẹ̀.', 'tracks.hosanna.number': 'Orin 08', 'tracks.hosanna.description': 'Orin ìyìn àti ìjọsìn tó kún fún ìgbàgbọ́.', 'tracks.hosanna.about': 'Hosanna jẹ́ orin ìjọsìn tó ń pe àwọn olùgbọ́ sínú ìyìn, ìgbàgbọ́ àti ìfọkànsìn ọkàn.', 'hosannaSynopsis': 'Orin ìyìn àti ìjọsìn tó kún fún ìgbàgbọ́.', 'tracks.hosanna.credits': 'Olórin: Carine Sanadina\nOmoluabi Productions ló gbé e kalẹ̀', 'tracks.hosanna.playLabel': 'Mu Hosanna ṣiṣẹ́', 'tracks.hosanna.lyricsFallback': 'Ọ̀rọ̀ orin ń bọ̀ láìpẹ́.' },
  de: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna von Carine Sanadina', 'tracks.hosanna.coverAlt': 'Carine-Sanadina-Logo für Hosanna', 'tracks.hosanna.fallback': 'Das Hosanna-Motiv ist vorübergehend nicht verfügbar.', 'tracks.hosanna.number': 'Titel 08', 'tracks.hosanna.description': 'Ein glaubensvolles Lied des Lobpreises und der Anbetung.', 'tracks.hosanna.about': 'Hosanna ist ein Worshipsong, der zu Lobpreis, Glauben und inniger Anbetung einlädt.', 'hosannaSynopsis': 'Ein glaubensvolles Lied des Lobpreises und der Anbetung.', 'tracks.hosanna.credits': 'Künstlerin: Carine Sanadina\nPräsentiert von Omoluabi Productions', 'tracks.hosanna.playLabel': 'Hosanna abspielen', 'tracks.hosanna.lyricsFallback': 'Liedtext folgt in Kürze.' },
  ar: { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Hosanna بصوت Carine Sanadina', 'tracks.hosanna.coverAlt': 'شعار Carine Sanadina لأغنية Hosanna', 'tracks.hosanna.fallback': 'صورة Hosanna غير متاحة مؤقتاً.', 'tracks.hosanna.number': 'المسار 08', 'tracks.hosanna.description': 'ترنيمة تسبيح وعبادة مفعمة بالإيمان.', 'tracks.hosanna.about': 'Hosanna ترنيمة عبادة تدعو المستمعين إلى أجواء من التسبيح والإيمان والتعبد الصادق.', 'hosannaSynopsis': 'ترنيمة تسبيح وعبادة مفعمة بالإيمان.', 'tracks.hosanna.credits': 'الفنانة: Carine Sanadina\nتقديم Omoluabi Productions', 'tracks.hosanna.playLabel': 'تشغيل Hosanna', 'tracks.hosanna.lyricsFallback': 'الكلمات ستتوفر قريباً.' },
  'zh-CN': { 'tracks.hosanna.title': 'Hosanna', 'tracks.hosanna.audioLabel': 'Carine Sanadina 演唱的 Hosanna', 'tracks.hosanna.coverAlt': 'Hosanna 的 Carine Sanadina 标志', 'tracks.hosanna.fallback': 'Hosanna 图片暂时无法显示。', 'tracks.hosanna.number': '曲目 08', 'tracks.hosanna.description': '一首充满信心的赞美与敬拜之歌。', 'tracks.hosanna.about': 'Hosanna 是一首敬拜歌曲，邀请听众进入赞美、信心与真挚敬拜的氛围。', 'hosannaSynopsis': '一首充满信心的赞美与敬拜之歌。', 'tracks.hosanna.credits': '艺人：Carine Sanadina\n呈现：Omoluabi Productions', 'tracks.hosanna.playLabel': '播放 Hosanna', 'tracks.hosanna.lyricsFallback': '歌词即将上线。' }
};
...
const CARINE_MUSIC_PLAYLIST = [
  ...
  },
  {
    ...
    lyrics: '',
    lyricsLrc: '',
    lyricsFallbackKey: 'tracks.hosanna.lyricsFallback',
    about: 'Hosanna is a worship song inviting listeners into an atmosphere of praise, faith, and heartfelt adoration.',
    credits: 'Artist: Carine Sanadina\nPresented by Omoluabi Productions',
    lyricsTimed: [],
